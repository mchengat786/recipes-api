...
import (
	...
	model "github.com/mchengat/recipes-api/models"
...
func NewRecipesHandler(ctx context.Context, collection *mongo.
	Collection, redisClient *redis.Client,
) *RecipesHandler {
...
func (handler *RecipesHandler) NewRecipeHandler(c *gin.Context) {
	if c.GetHeader("X_API_KEY") != os.Getenv("X_API_KEY") {
		c.JSON(http.StatusUnauthorized, gin.H{
			"error": "API key provided not valid.",
		})
		return
	}
	var recipe model.Recipe
...
func (handler *RecipesHandler) DeleteRecipeHandler(c *gin.Context) {
	...
	c.IndentedJSON(http.StatusOK, gin.H{"message": "Recipe has been deleted"})
}
